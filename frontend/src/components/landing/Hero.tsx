...
const Hero = () => {
  return (
    <section className="relative w-full min-h-screen flex items-center justify-center px-6 overflow-hidden pt-24">
      
      <div className="absolute inset-0 -z-10 bg-[var(--gradient-mesh)] blur-[140px] opacity-80" />

      <div className="absolute top-[45%] left-1/2 -translate-x-1/2 w-[450px] h-[450px] bg-[var(--accent-core)] opacity-20 blur-[160px] rounded-full" />

      <div className="max-w-[1000px] w-full mx-auto text-center flex flex-col items-center gap-7">
        
        <div className="inline-flex items-center gap-2 px-5 py-2 rounded-full border border-[var(--border-subtle)] bg-[var(--bg-glass)] backdrop-blur-xl shadow-[var(--shadow-soft)] transition hover:scale-[1.04]">
        ...
        {/* ✅ Use base h1 + responsive scaling */}
        <h1 className="text-[38px] sm:text-[48px] lg:text-[60px] leading-[1.05] tracking-tight text-[var(--text-primary)]">
          SpeakUp.{" "}
        ...
        {/* ✅ Base p = 16px → scale slightly */}
        <p className="text-[16px] sm:text-[18px] text-[var(--text-secondary)] max-w-2xl leading-relaxed">
        ...
        <p className="text-[14px] sm:text-[15px] text-[var(--text-muted)] max-w-lg">
